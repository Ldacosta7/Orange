...
public class ApiOrange {
    ...
    public static void getMaterielsUser (Context context, Integer idUser, IMaterielObserver observer){
        RequestQueue queue = Volley.newRequestQueue(context);
    ...
    public static void getAllMateriels (Context context, IMaterielObserver observer){
        RequestQueue queue = Volley.newRequestQueue(context);
        StringRequest request = new StringRequest(URL_API + "/materiel",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ArrayList<Materiel> materiels = new ArrayList<Materiel>();
    ...
    public static void getInterventionUser (Context context, Integer idUser, IIterventionObserver observer){
        RequestQueue queue = Volley.newRequestQueue(context);
    ...
    public static void getAllInterventions (Context context, IIterventionObserver observer){
        RequestQueue queue = Volley.newRequestQueue(context);
        StringRequest request = new StringRequest(URL_API + "/intervention",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ArrayList<Intervention> interventions = new ArrayList<Intervention>();
